...
<div align="center">
  <a href="https://github.com/DaveWooo/Deepseek-Zoom">
...
| **DeepSeek Web (Free)** | `deepseek_web.js`      | Quick mode (V4 Flash) / Expert mode (R1) / Vision mode | **No API key**; reuses the free `chat.deepseek.com` session; three-mode switching with reasoning display and web search; image upload (PoW + fork) | DeepSeek account login (phone/email + password in Settings) |
...
1. Download the latest ZIP from [Releases](https://github.com/DaveWooo/Deepseek-Zoom/releases) and unzip it.
