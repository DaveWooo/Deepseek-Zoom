...
export const DOM_IDS = {
    ...
    GEMINI_WEB_MODEL_ENABLED_FLASH: 'gemini-web-model-enabled-flash',
    GEMINI_WEB_MODEL_ENABLED_LITE: 'gemini-web-model-enabled-lite',
    GEMINI_WEB_MODEL_ENABLED_PRO: 'gemini-web-model-enabled-pro',
    GEMINI_WEB_STATUS_DOT_FLASH: 'gemini-web-status-flash',
    GEMINI_WEB_STATUS_DOT_LITE: 'gemini-web-status-lite',
    GEMINI_WEB_STATUS_DOT_PRO: 'gemini-web-status-pro',
